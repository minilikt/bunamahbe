        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            {[
              ...
              { icon: Vote, value: stats.votes, label: "Votes Cast", suffix: "" },
              { icon: MapPin, value: stats.cities, label: "Cities Represented", suffix: "" },
            ].map((stat, i) => (
              <motion.div
                key={stat.label}
                initial={{ opacity: 0, y: 20 }}
